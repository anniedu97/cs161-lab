...
LAB25:    xsi_set_current_line(135, ng0);
    ...
    t2 = ((char*)((ng1)));
    memset(t8, 0, 8);
    xsi_vlog_signed_equal(t8, 32, t4, 4, t2, 32);
    t5 = (t8 + 4);
    t14 = *((unsigned int *)t5);
    t15 = (~(t14));
    t16 = *((unsigned int *)t8);
...
LAB56:    xsi_set_current_line(73, ng0);
    ...
    t7 = *((char **)t4);
    memset(t8, 0, 8);
    xsi_vlog_signed_add(t8, 4, t5, 4, t7, 4);
    t4 = (t0 + 4272);
    xsi_vlogvar_assign_value(t4, t8, 0, 0, 4);
    ...
    t2 = ((char*)((ng1)));
    memset(t8, 0, 8);
    xsi_vlog_signed_greatereq(t8, 32, t4, 4, t2, 32);
    memset(t12, 0, 8);
    t5 = (t8 + 4);
    t14 = *((unsigned int *)t5);
    t15 = (~(t14));
...
LAB86:    xsi_set_current_line(77, ng0);
    ...
    t2 = ((char*)((ng1)));
    memset(t8, 0, 8);
    xsi_vlog_signed_less(t8, 32, t4, 4, t2, 32);
    memset(t12, 0, 8);
    t5 = (t8 + 4);
    t14 = *((unsigned int *)t5);
    t15 = (~(t14));
...
LAB152:    xsi_set_current_line(97, ng0);
    ...
    t7 = *((char **)t4);
    memset(t8, 0, 8);
    xsi_vlog_signed_minus(t8, 4, t5, 4, t7, 4);
    t4 = (t0 + 4272);
    xsi_vlogvar_assign_value(t4, t8, 0, 0, 4);
...
LAB230:    xsi_set_current_line(124, ng0);
    ...
    t4 = ((char*)((ng3)));
    memset(t8, 0, 8);
    xsi_vlog_unsigned_arith_rshift(t8, 4, t5, 4, t4, 32);
    t7 = (t0 + 4272);
...
LAB61:    t10 = (t0 + 3872U);
    ...
    t10 = ((char*)((ng1)));
    memset(t29, 0, 8);
    xsi_vlog_signed_greatereq(t29, 32, t11, 4, t10, 32);
    memset(t32, 0, 8);
    t13 = (t29 + 4);
...
LAB75:    t33 = (t0 + 4272);
    ...
    t45 = ((char*)((ng1)));
    memset(t83, 0, 8);
    xsi_vlog_signed_less(t83, 32, t44, 4, t45, 32);
    memset(t84, 0, 8);
    t46 = (t83 + 4);
...
LAB93:    t10 = (t0 + 3872U);
    ...
    t10 = ((char*)((ng1)));
    memset(t29, 0, 8);
    xsi_vlog_signed_less(t29, 32, t11, 4, t10, 32);
    memset(t32, 0, 8);
    t13 = (t29 + 4);
    t34 = *((unsigned int *)t13);
    t35 = (~(t34));
...
LAB107:    t33 = (t0 + 4272);
    ...
    t45 = ((char*)((ng1)));
    memset(t83, 0, 8);
    xsi_vlog_signed_greatereq(t83, 32, t44, 4, t45, 32);
    memset(t84, 0, 8);
    t46 = (t83 + 4);
    t85 = *((unsigned int *)t46);
    t86 = (~(t85));
