...
static void Initial_129_9(char *t0)
{
    char *t1;
    char *t2;
...
LAB2:    t2 = (t0 + 17368U);
    ...
    t2 = ((char*)((ng3)));
    memset(t4, 0, 8);
    xsi_vlog_unsigned_divide(t4, 32, t3, 1, t2, 32);
    t5 = ((char*)((ng4)));
    memset(t6, 0, 8);
