...
static void Initial_128_10(char *t0)
{
    char *t1;
    char *t2;
...
LAB2:    t2 = (t0 + 6328U);
    ...
    t2 = ((char*)((ng5)));
    memset(t5, 0, 8);
    xsi_vlog_unsigned_arith_lshift(t5, 32, t4, 1, t2, 32);
    memset(t6, 0, 8);
